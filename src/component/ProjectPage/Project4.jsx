    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1 relative px-8 pt-6">
          ...
          <a href="https://github.com/RohitKumar7830/space" target="_blank" rel="noopener noreferrer">
          ...
          <div className="mt-16">
            ...
            Sentimental Analysis on Space Experience
            </h2>
            <p className="text-gray-600 text-sm md:text-base">
              Machine Learning<span className="px-2">-</span> May 2024
            </p>
          </div>
        </div>
